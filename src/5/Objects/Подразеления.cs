    ...
    public class Подразеления : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПодразеленияE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПодразеленияE", typeof(IIS.5.Подразеления));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПодразеленияL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПодразеленияL", typeof(IIS.5.Подразеления));
                }
            }
        }
    }
